        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              <div>
                <h2 className="sora" style={{ fontSize: 20, fontWeight: 700, color: "#1E3A5F", marginBottom: 12 }}>1. Introduction</h2>
                <p style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
                  DynaPrizes ("we", "our", "us") respects your privacy. This Privacy Policy explains how we collect, use, and protect your personal information when you use our website and services.
                </p>
              </div>

              <div>
                <h2 className="sora" style={{ fontSize: 20, fontWeight: 700, color: "#1E3A5F", marginBottom: 12 }}>2. Information We Collect</h2>
                <p style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
                  We collect information you provide directly, such as:
                </p>
                <ul style={{ fontSize: 15, color: "#475569", lineHeight: 1.8, paddingLeft: 24, marginTop: 8 }}>
                  <li>Name and email address (when you sign up)</li>
                  <li>Product preferences and search history</li>
                  <li>Price alerts you set</li>
                  <li>Cart items</li>
                </ul>
              </div>

              <div>
                <h2 className="sora" style={{ fontSize: 20, fontWeight: 700, color: "#1E3A5F", marginBottom: 12 }}>3. How We Use Your Information</h2>
                <p style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
              ...
              <div>
                <h2 className="sora" style={{ fontSize: 20, fontWeight: 700, color: "#1E3A5F", marginBottom: 12 }}>4. Data Security</h2>
                <p style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
                  We use industry-standard encryption (JWT tokens, bcrypt hashing) to protect your data. We never share your personal information with third parties without your consent, except as required by law.
                </p>
              </div>

              <div>
                <h2 className="sora" style={{ fontSize: 20, fontWeight: 700, color: "#1E3A5F", marginBottom: 12 }}>5. Your Rights</h2>
                <p style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
              ...
              <div>
                <h2 className="sora" style={{ fontSize: 20, fontWeight: 700, color: "#1E3A5F", marginBottom: 12 }}>6. Contact Us</h2>
                <p style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
