        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              <div>
                <h2 className="sora" style={{ fontSize: 20, fontWeight: 700, color: "#1E3A5F", marginBottom: 12 }}>1. What Are Cookies?</h2>
              ...
              <div>
                <h2 className="sora" style={{ fontSize: 20, fontWeight: 700, color: "#1E3A5F", marginBottom: 12 }}>2. How We Use Cookies</h2>
                <p style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
                  We use cookies to:
                </p>
                <ul style={{ fontSize: 15, color: "#475569", lineHeight: 1.8, paddingLeft: 24, marginTop: 8 }}>
                  <li>Keep you logged in (authentication)</li>
                  <li>Remember your preferences</li>
                  <li>Store recently viewed products</li>
                  <li>Analyze site traffic and performance</li>
                </ul>
              </div>

              <div>
                <h2 className="sora" style={{ fontSize: 20, fontWeight: 700, color: "#1E3A5F", marginBottom: 12 }}>3. Types of Cookies</h2>
                <ul style={{ fontSize: 15, color: "#475569", lineHeight: 1.8, paddingLeft: 24 }}>
                  <li><strong>Essential Cookies:</strong> Required for basic functionality (login, cart)</li>
              ...
              <div>
                <h2 className="sora" style={{ fontSize: 20, fontWeight: 700, color: "#1E3A5F", marginBottom: 12 }}>4. Managing Cookies</h2>
                <p style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
                ...
                <p style={{ fontSize: 15, color: "#475569", lineHeight: 1.8, marginTop: 8 }}>
                  Note: Disabling cookies may affect your experience on our site.
                </p>
              </div>

              <div>
                <h2 className="sora" style={{ fontSize: 20, fontWeight: 700, color: "#1E3A5F", marginBottom: 12 }}>5. Third-Party Cookies</h2>
                <p style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
              ...
              <div>
                <h2 className="sora" style={{ fontSize: 20, fontWeight: 700, color: "#1E3A5F", marginBottom: 12 }}>6. Contact</h2>
                <p style={{ fontSize: 15, color: "#475569", lineHeight: 1.8 }}>
